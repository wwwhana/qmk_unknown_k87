...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_k87_ansi(
	     TK_RST,                KC_BRMD,      KC_BRMU, _______,    _______, _______, _______,    KC_MPRV,    KC_MPLY,    KC_MNXT,    KC_MUTE,    KC_VOLD,    KC_VOLU,    NK_ON,      NK_OFF,     RGB_TOG,
		...
		_______,    _______,    _______,      _______, _______,       T_TM, _______, _______,    _______,    _______,    DM_REC1,    DM_REC2,    DM_RSTP,    RGB_VAD,    RGB_M_SW,   RGB_MOD,    RGB_RMOD,
		KC_CAPS,    _______,    _______,      _______, _______,    _______, _______, _______,    _______,    _______,    DM_PLY1,    DM_PLY2,                RGB_HUI,
		_______,                _______,      _______, _______,    _______, _______, _______,    _______,    RGB_SAI,    RGB_SAD,      T_NUM,                RGB_HUD,                KC_WH_U,
