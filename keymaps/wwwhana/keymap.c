...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT_k87_ansi(  
	      ...
	      _______,    _______,    KC_WH_D,                                    KC_P0,                                     KC_PDOT,    MO(_FN),    _______,    _______,    _______,    _______,    _______
    ),
    [_FN] = LAYOUT_k87_ansi(      
		      RESET,                KC_MSEL,      KC_VOLD, KC_VOLU,    KC_MUTE, KC_MSTP, KC_MPRV,    KC_MPLY,    KC_MNXT,    KC_MAIL,    KC_WHOM,    KC_CALC,    RGB_TOG,    NK_ON,      NK_OFF,     KC_SLEP,
		    ...
		    _______,    _______,    _______,      _______, _______,    _______, _______, _______,    _______,    _______,    _______,   TO(_NUM),                _______,                                    
		    _______,                _______,      _______, _______,    _______, _______, _______,    TO(_MAC),   _______,    _______,    _______,                _______,                RGB_VAI,            
